...
import { bnbCodes } from "../data/codes"; // make sure this exists
...
const BNBVisualizer = () => {
  ...
  // Placeholder Branch & Bound simulations
  const runKnapsack = async () => {
    setIsRunning(true);
    alert("0/1 Knapsack Branch & Bound visualization coming soon!");
    setIsRunning(false);
  };
  ...
  const bnbFunctions = {
    knapsack01: runKnapsack,
    maximumSubarray: runGeneric,
      ...
      <section className="px-8 md:px-20 pt-32 pb-16 bg-[#F9FAFB] text-[#1A1A1A]">
        ...
        <motion.div className="text-center mb-12" initial="hidden" animate="visible" variants={fadeInUp}>
          ...
          <p className="mt-4 text-xl text-[#555555] max-w-3xl mx-auto">
            Visualize how Branch & Bound algorithms explore solution spaces and prune non-promising branches. Select an algorithm and programming language to view its code and demo.
          </p>
        </motion.div>
        ...
        <motion.div className="mb-12" initial="hidden" animate="visible" variants={fadeInUp}>
          <div className="bg-white border border-gray-200 rounded-2xl shadow-md p-6 max-w-4xl mx-auto">
            <pre className="bg-[#1E1E1E] text-green-400 rounded-xl p-6 overflow-x-auto text-sm leading-relaxed">
              {bnbCodes[selectedAlgo][selectedLang]}
            </pre>
          </div>
        </motion.div>
        ...
        <motion.div className="mb-16" initial="hidden" animate="visible" variants={fadeInUp}>
          <div className="bg-white border border-gray-200 rounded-2xl shadow-md p-6 max-w-4xl mx-auto">
            ...
            <div className="flex justify-center gap-4 mt-6">
              ...
              <button
                onClick={() => bnbFunctions[selectedAlgo]()}
                disabled={isRunning}
